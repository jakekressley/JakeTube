// handles all of the google cloud storage interactions and local file interactions
...
* @param processed VideoName - The name of the file to convert to {@link localProcessedVideoPath}
...
/**
 * @param fileName - The name of the file to upload from the {@link localProcessedVideoPath} directory into the {@link processedVideoBucketName} bucket.
